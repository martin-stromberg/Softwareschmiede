...
- Das GitHub-Plugin kann Pull-Request-Status und GitHub-Actions-/Workflow-Runs fuer gespeicherte Aufgaben-Pull-Requests abfragen. Optional kann es Pull Requests nach erfolgreichen Actions automatisch abschliessen.
