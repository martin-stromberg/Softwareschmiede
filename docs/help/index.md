...
- [Entwicklungsumgebungen](entwicklungsumgebungen/index.md) — IDE-Plugin-System mit automatischer Erkennung und Auswahl der passenden Entwicklungsumgebung (Visual Studio für `.sln`/`.slnx`-Dateien, Visual Studio Code als Fallback); Benutzer können IDEs aktivieren/deaktivieren und ihre Prioritätsreihenfolge konfigurieren.
