...
Optional kann ein ausgewählter Template-Text mit einem im Dialog gewählten KI-Provider ausgefüllt werden. Verfügbare KI-Provider für die Issue-Ausfüllhilfe sind Codex, Claude, Devin und GitHub Copilot. Die KI-Ausfüllhilfe ist unabhängig von der normalen Issue-Anlage und kann bei fehlendem oder nicht geeignetem KI-Provider nicht verwendet werden.
