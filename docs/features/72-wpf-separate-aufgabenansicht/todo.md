...
Branch: `72-wpf-separate-aufgabenansicht`

| Status | Schritt | Beschreibung | Artefakt |
|--------|---------|--------------|----------|
| [x] | 1 | Branch-Name ermitteln | – |
| [x] | 2 | Verzeichnisstruktur vorbereiten | `docs/features/72-wpf-separate-aufgabenansicht/` |
...
| [x] | – | Iteration oder Abschluss entscheiden (3 Iterationen, Abbruch nach Max) | – |
