...
Branch: `repository-suggestion`

| Status | Schritt | Beschreibung | Artefakt |
|--------|---------|--------------|----------|
| [x] | 1 | Branch-Name ermitteln | – |
| [x] | 2 | Verzeichnisstruktur vorbereiten | `docs/features/repository-suggestion/` |
| [x] | – | Einstiegspunkt ermitteln (Fortsetzung via continue.md) | – |
...
| [x] | 5b | Planungscommit | – |
| [x] | 6 | Implementierung (Unteragent) — Fortsetzung via continue.md | Codeänderungen |
