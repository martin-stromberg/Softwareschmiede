...
- [ ] Die noch vorhandenen Dateien rund um die Agentenpakete (`IAgentPackageService`) sollen entfernt werden. Erstelle ein Issue im Repository, um die Entfernung dieser Dateien zu planen und zu dokumentieren. Die README muss dabei dann beachtet werden.
