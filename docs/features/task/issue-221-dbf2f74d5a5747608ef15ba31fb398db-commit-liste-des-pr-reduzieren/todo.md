...
Branch: `task/issue-221-dbf2f74d5a5747608ef15ba31fb398db-commit-liste-des-pr-reduzieren`

| Status | Schritt | Beschreibung | Artefakt |
|--------|---------|--------------|----------|
| [x] | 1 | Branch-Name ermitteln | – |
| [x] | 2 | Verzeichnisstruktur vorbereiten | `docs/features/task/issue-221-dbf2f74d5a5747608ef15ba31fb398db-commit-liste-des-pr-reduzieren/` |
...
| [ ] | 5a | Offene Punkte prüfen | `plan.md` (aktualisiert) |
| [ ] | 5b | Planungscommit | – |
