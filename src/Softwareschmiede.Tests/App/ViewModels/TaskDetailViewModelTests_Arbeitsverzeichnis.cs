...
/// <summary>Unit-Tests für TaskDetailViewModel.OeffneArbeitsverzeichnisAsync(): Nutzung des WorkingDirectoryResolver.</summary>
public sealed class TaskDetailViewModelTests_Arbeitsverzeichnis : IDisposable
{
    ...
    /// <summary>TaskDetailViewModelTests_Arbeitsverzeichnis.</summary>
    public TaskDetailViewModelTests_Arbeitsverzeichnis()
    {
    ...
    private string CreateTempDirectory()
        => _tempDirectoryFixture.CreateTempDirectory("tdvm_arbeitsverzeichnis_tests");

    private TaskDetailViewModel CreateSut(Mock<IProzessStarter>? prozessStarterMock = null)
    {
